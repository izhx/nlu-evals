...
def main():
    ...
    def compute_metrics(p):
        ...
        results = metric_compute(predictions=true_predictions, references=true_labels)
    ...
    if training_args.do_predict:
        ...
        for config_name in config_names:
            ...
            # Save predictions
            output_predictions_file = os.path.join(training_args.output_dir, f"predictions-{config_name}.txt")
